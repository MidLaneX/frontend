...
export function getOrganizationRole(
  ...
  console.log(
    "getOrganizationRole - Checking role for user:",
    userIdString,
    "against owner:",
    ownerIdString,
  );
  console.log(
    "getOrganizationRole - Raw organization owner_id:",
    (organization as any).owner_id,
    "ownerId:",
    organization.ownerId,
  );
  console.log(
    "getOrganizationRole - Types - currentUserId:",
    typeof currentUserId,
    "ownerIdFromApi:",
    typeof ownerIdFromApi,
  );
  console.log(
    "getOrganizationRole - Numbers - currentUserId:",
    userIdNumber,
    "ownerIdFromApi:",
    ownerIdNumber,
  );
  ...
  const isOwnerNumber =
    !isNaN(userIdNumber) &&
    !isNaN(ownerIdNumber) &&
    userIdNumber === ownerIdNumber;
  const isOwner = isOwnerString || isOwnerNumber;

  const role = isOwner ? "owner" : "member";

  console.log(
    "getOrganizationRole - String match:",
    isOwnerString,
    "Number match:",
    isOwnerNumber,
    "Final result:",
...
export function getOrganizationPermissions(
  ...
  console.log(
    "getOrganizationPermissions - Organization:",
    organization.name,
    "User:",
    currentUserId,
    "IsOwner:",
  ...
  console.log(
    "getOrganizationPermissions - Calculated permissions:",
    permissions,
  );
...
export function enrichOrganizationWithRole(
  ...
  console.log(
    "enrichOrganizationWithRole - Organization:",
    organization.name,
    "UserRole:",
    userRole,
    "IsOwner:",
...
export function filterOrganizationsByRole(
  ...
  return organizations.filter(
    (org) => getOrganizationRole(org, currentUserId) === role,
  );
}
