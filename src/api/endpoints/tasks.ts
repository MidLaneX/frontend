...
export const tasksApi = {
  ...
  getTasks: (projectId: number, templateType = "scrum") => {
    return projectsApiClient.get<Task[]>(
      `/projects/${projectId}/tasks?templateType=${templateType}`,
    );
  },
  ...
  getTask: (projectId: number, taskId: number, templateType = "scrum") => {
    return projectsApiClient.get<Task>(
      `/projects/${projectId}/tasks/${taskId}?templateType=${templateType}`,
    );
  },
  ...
  createTask: (
    ...
    return projectsApiClient.post<Task>(
      `/projects/${projectId}/tasks?templateType=${templateType}`,
      data,
    );
  },
  ...
  updateTaskStatus: (
    ...
    console.log(
      "Sending updateTaskStatus request to:",
