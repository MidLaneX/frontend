  ...
  const features = [
    {
      ...
      description:
        "Get your projects up and running in minutes with our streamlined setup process.",
    },
    {
      icon: <TeamIcon sx={{ fontSize: 40, color: "#00875A" }} />,
      title: "Team Collaboration",
      description:
        "Built-in tools for seamless team communication and project coordination.",
    },
    {
      icon: <AnalyticsIcon sx={{ fontSize: 40, color: "#FF8B00" }} />,
      title: "Advanced Analytics",
      description:
        "Deep insights into project performance and team productivity metrics.",
    },
    {
    ...
    },
    {
      ...
      title: "Cloud-Native",
      description:
        "Fully cloud-based solution with 99.9% uptime and global accessibility.",
    },
    {
    ...
    >
      <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        <Box sx={{ textAlign: "center", mb: 8 }}>
          ...
          >
            Empowering teams to deliver exceptional results through intelligent
            project management
          </Typography>
          ...
          >
            MidLaneX is the next-generation project management platform that
            combines powerful features with intuitive design to help teams of
            all sizes achieve their goals faster and more efficiently.
          </Typography>
        </Box>
        ...
        >
          ...
          >
            <Box>
              ...
              >
                To revolutionize how teams collaborate and manage projects by
                providing an intelligent, flexible, and user-friendly platform
                that adapts to any workflow, methodology, or industry
                requirement.
              </Typography>
            </Box>
            <Box sx={{ display: "flex", justifyContent: "center" }}>
              <InnovationIcon
                sx={{ fontSize: 200, color: "#0052CC", opacity: 0.8 }}
              />
            </Box>
          </Box>
        </Paper>
        ...
        <Box sx={{ mb: 8 }}>
          ...
          >
            Discover the powerful features that set MidLaneX apart from
          ...
          >
            ...
            >
              ...
              >
                ...
                multiple project methodologies and can adapt to any team size or
