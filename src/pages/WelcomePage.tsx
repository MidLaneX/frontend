        ...
        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
          <Box sx={{ textAlign: 'center', mb: 6 }}>
            <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', mb: 4 }}>
              ...
              >
                <Typography sx={{ color: 'white', fontWeight: 'bold', fontSize: 48 }}>
                  M
                </Typography>
              </Box>
              <Box>
            ...
            <Typography variant="h4" sx={{ 
              ...
              Empower your team to build exceptional software with the world's most intuitive project management platform
            </Typography>
            ...
            <Typography variant="h6" sx={{ 
              ...
              Trusted by 50,000+ teams worldwide to deliver projects faster, collaborate better, and scale efficiently
            </Typography>
      ...
      <Container maxWidth="lg" sx={{ py: 8 }}>
        <Box sx={{ textAlign: 'center', mb: 6 }}>
          ...
          <Typography variant="h6" sx={{ 
            ...
            Join the thousands of teams who've revolutionized their project management with our enterprise-grade platform
          </Typography>
        </Box>
              ...
              <Box>
                {benefits.map((benefit, index) => (
                  <Box key={index} sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                    <CheckCircleIcon sx={{ color: '#00875A', mr: 2, fontSize: 20 }} />
                    <Typography variant="body1" sx={{ color: '#5E6C84', fontWeight: 500 }}>
                      {benefit}
                    </Typography>
                  </Box>
                ))}
          ...
          <div>
            ...
            >
              ...
              {testimonials.map((testimonial, index) => (
                <Box key={index} sx={{ mb: 3, p: 3, bgcolor: '#F8F9FA', borderRadius: 2 }}>
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                    <Avatar sx={{ bgcolor: '#0052CC', mr: 2, width: 40, height: 40 }}>
                      {testimonial.avatar}
                    </Avatar>
                    <Box>
                    ...
                    <Box sx={{ ml: 'auto', display: 'flex' }}>
                      {[1,2,3,4,5].map((star) => (
                        <StarIcon key={star} sx={{ color: '#FFAB00', fontSize: 16 }} />
                      ))}
                    </Box>
                  </Box>
                  <Typography variant="body2" sx={{ color: '#5E6C84', fontStyle: 'italic' }}>
                    "{testimonial.content}"
                  </Typography>
                </Box>
              ))}
      ...
      <Container maxWidth="lg" sx={{ py: 8 }}>
        <Box sx={{ textAlign: 'center', mb: 6 }}>
          ...
          <Typography variant="h6" sx={{ 
            ...
            Discover the comprehensive suite of tools designed to streamline your workflow and accelerate project delivery
          </Typography>
        </Box>
        ...
        <Container maxWidth="md" sx={{ position: 'relative', zIndex: 1 }}>
          <Box sx={{ textAlign: 'center', color: 'white' }}>
            ...
            <Typography variant="h6" sx={{ 
              ...
              Join 50,000+ teams who trust MidLineX to deliver exceptional software faster and more efficiently than ever before.
            </Typography>
