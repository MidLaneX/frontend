...
const ModernDashboard: React.FC = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      // Fetch recent projects (mock for now)
      const mockRecentProjects: RecentProject[] = [
        {
          id: 1,
          name: 'E-Commerce Platform',
          description: 'Building the next generation shopping experience',
          organizationName: orgsData[0]?.name || 'Default Org',
          teamName: allTeams[0]?.team_name || 'Development Team',
          progress: 75,
          status: 'active',
        ...
        },
        {
          ...
          description: 'Modernizing our mobile application UI/UX',
          organizationName: orgsData[0]?.name || 'Default Org',
          teamName: allTeams[1]?.team_name || 'Design Team',
          progress: 45,
          status: 'active',
        ...
        },
        {
          ...
          organizationName: orgsData[1]?.name || 'Tech Org',
          progress: 90,
          status: 'active',
      ...
      setStats({
        ...
        totalProjects: mockRecentProjects.length,
        recentActivity: 12,
      });
