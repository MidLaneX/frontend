...
const mockTeams: MockTeam[] = [
  ...
  { id: 4, name: 'QA Team', description: 'Quality assurance engineers', memberCount: 5 },
  { id: 5, name: 'DevOps Team', description: 'Infrastructure and deployment', memberCount: 3 },
  { id: 6, name: 'Data Team', description: 'Data scientists and analysts', memberCount: 4 },
];
