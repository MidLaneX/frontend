...
import { getTemplateFeatures } from '@/types/template';
import { getFeatureComponent } from '@/utils/featureRegistry';
import { getInitials } from '@/utils';

// Import existing components to populate the registry
import ProjectSummary from './ProjectSummary';
import ProjectTimeline from './ProjectTimeline';
import ProjectBacklog from './ProjectBacklog';
import ProjectBoard from './ProjectBoard';

// Populate the component registry with existing components
import { FEATURE_COMPONENTS } from '@/utils/featureRegistry';
FEATURE_COMPONENTS['ProjectSummary'] = ProjectSummary;
FEATURE_COMPONENTS['ProjectTimeline'] = ProjectTimeline;
FEATURE_COMPONENTS['ProjectBacklog'] = ProjectBacklog;
FEATURE_COMPONENTS['ProjectBoard'] = ProjectBoard;
FEATURE_COMPONENTS['ProductBacklog'] = ProjectBacklog; // Use existing backlog for now
FEATURE_COMPONENTS['SprintBoard'] = ProjectBoard; // Use existing board for now
FEATURE_COMPONENTS['KanbanBoard'] = ProjectBoard; // Use existing board for now
 ...
 * 
 * Provides dynamic navigation based on the project's template type and features.
 * Features are loaded from the backend and displayed as tabs.
 */
